/*
 * bench_min.cpp - Compare MIN: libmat vs Eigen
 *
 * result = min(A) (minimum element)
 *
 * Build:
 *   make bench-compare-min
 */
...
int main(int argc, char** argv) {
    ...
    zap_compare_group_t* g = zap_compare_group("min");
