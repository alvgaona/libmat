/*
 * bench_sin.cpp - Compare SIN: libmat vs Eigen
 *
 * B = sin(A) (element-wise sine)
 *
 * Build:
 *   make bench-compare-sin
 */
...
void bench_libmat(zap_bencher_t* b, void* param) {
    sin_ctx_t* ctx = (sin_ctx_t*)param;
    // Operations: n sin calls
...
int main(int argc, char** argv) {
    ...
    zap_compare_group_t* g = zap_compare_group("sin");
