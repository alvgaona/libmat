/*
 * bench_mean.cpp - Compare MEAN: libmat vs Eigen
 *
 * result = mean(A) (average of all elements)
 *
 * Build:
 *   make bench-compare-mean
 */
...
void bench_libmat(zap_bencher_t* b, void* param) {
    mean_ctx_t* ctx = (mean_ctx_t*)param;
...
int main(int argc, char** argv) {
    ...
    zap_compare_group_t* g = zap_compare_group("mean");
