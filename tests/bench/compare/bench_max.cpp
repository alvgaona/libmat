/*
 * bench_max.cpp - Compare MAX: libmat vs Eigen
 *
 * result = max(A) (maximum element)
 *
 * Build:
 *   make bench-compare-max
 */
...
int main(int argc, char** argv) {
    ...
    zap_compare_group_t* g = zap_compare_group("max");
