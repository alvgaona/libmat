/*
 * bench_sum.cpp - Compare SUM: libmat vs Eigen
 *
 * result = sum(A) (sum of all elements)
 *
 * Build:
 *   make bench-compare-sum
 */
...
void bench_libmat(zap_bencher_t* b, void* param) {
    sum_ctx_t* ctx = (sum_ctx_t*)param;
    // Memory bandwidth: read n
...
int main(int argc, char** argv) {
    ...
    zap_compare_group_t* g = zap_compare_group("sum");
