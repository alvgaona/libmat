...
void bench_speed(size_t m, size_t n) {
  ...
  // Eigen uses column-major by default, same as our MAT_COLUMN_MAJOR
...
int main() {
  ...
  printf("=== QR (R-only) BENCHMARK: libmat vs Eigen [%s] ===\n", PRECISION_NAME);
  printf("mat_qr_r vs Eigen HouseholderQR (R factor only)\n");
